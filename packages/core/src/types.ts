 ...
 * **IMPORTANT** - Readonly!
 */
export type ASTNode = CaptureRuleASTNode | MatchRuleASTNode | IncludeOnlyRuleASTNode | BeginWhileRuleASTNode | BeginEndRuleASTNode;
...
export class Range{
	...
	static create(): Range{
		...
		if (
			...
			args.length === 4 &&
			args.every(one => typeof one === 'number')
		){
