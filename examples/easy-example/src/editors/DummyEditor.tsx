        ...
        pipeline: createPkgValDesc(['**Return package pipeline**', 'Package pipeline'], {
          ...
          libraryVariables: createPkgValDesc(['Library variables package'], {
            Variables_1_conn_1: createPkgValDesc(['ConnectionType'], {
              connectionId: createRefValDesc(['Connection Id'], IdentifierType.String),
            }),
            Variables_1_conn_2: createPkgValDesc(['ConnectionType'], {
              connectionId: createRefValDesc(['Connection Id'], IdentifierType.String),
            }),
            Variables_1_item_1: createPkgValDesc(['ItemType'], {
              itemId: createRefValDesc(['Item Id'], IdentifierType.String),
              workspaceId: createRefValDesc(['Workspace Id'], IdentifierType.String),
            }),
            Variables_1_item_2: createPkgValDesc(['ItemType'], {
              itemId: createRefValDesc(['Item Id'], IdentifierType.String),
              workspaceId: createRefValDesc(['Workspace Id'], IdentifierType.String),
            }),
          }),
